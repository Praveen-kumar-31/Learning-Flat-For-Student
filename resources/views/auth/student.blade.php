                ...
                <nav class="sb-sidenav accordion sb-sidenav-dark" id="sidenavAccordion">
                    <div class="sb-sidenav-menu">
                        <div class="nav">
                            ...
                            <a class="nav-link" href="{{url('viewcourse')}}">
                                <div class="sb-nav-link-icon"><i class="fas fa-tachometer-alt"></i></div>
                                Course
                            </a>
            ...
            <div class="col-md-8">
                <div class="card shadow">
                    ...
                    <div class="card-body">                   
                        ...
                        @endif
                        @if (!empty($user->batch))
                            <p>Batch:      {{ $user->batch->name }}</p>
                        @endif
                      
                        <button class=" btn btn-primary"><a href="/viewcourse" class="text-white" style="text-decoration:none">Course</a></button>
                    </div>
                </div>
            </div>
        </div>
